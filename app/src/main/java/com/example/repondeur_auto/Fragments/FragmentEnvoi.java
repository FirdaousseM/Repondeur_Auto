package com.example.repondeur_auto.Fragments;
...
public class FragmentEnvoi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View result = inflater.inflate(R.layout.fragment_envoi, container, false);

        // Get the TextView from the layout
        textView = result.findViewById(R.id.text_view_c);
